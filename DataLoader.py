...
argparser.add_argument("--host", default="localhost", help="Connect to the MySQL server on the given host.")
argparser.add_argument("-d", "--database", help="Database that you would like to load random data into.")
argparser.add_argument("-p", "--password", help="MySQL password.")
...
argparser.add_argument("-r", "--rows_to_create_per_table", default=10000, type=int, help="The number of rows to create per table.")
argparser.add_argument("--menu", action='store_true', help="Use this if you would like the menu, which allows for configuration of table and column level properties.")
argparser.add_argument("--rows_per_insert", default=50, type=int, help="The number of rows to create per insert statement.")
...
argparser.add_argument("--cardinality", default=None, type=int, help="The number of unique values to be generated for each column")
argparser.add_argument("--referential_sample_size", default=5000, type=int, help="This sets the number of values that will be retrieved from the databases when generating data from a referential source.  Reducing this number will reduce cardinality, but will also reduce the amount of memory used by the program.  A cardinality property or a unique column will override referential sample size")
...
argparser.add_argument("--no_bin_log", action='store_true', help="Disable writing to the bin log for this session")
